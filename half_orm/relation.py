...
to generate the classes that will be used to manipulate the data in your
database.
...
class Relation:
    """Used as a base class for the generated Tables and Views classes.
...
def get(self, *args: List[str]) -> Relation:
    ...
    Example:
        >>> gaston = Person(last_name='Lagaffe', first_name='Gaston').get()
