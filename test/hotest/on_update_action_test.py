...
class Test(HoTestCase):
    ...
    def test_restrict(self):
        ...
        halftest.model.reconnect(reload=True)
        self.hotAssertOnUpdateRestict(self.RelB, 'b_a_fkey')
    ...
    def test_cascade(self):
        ...
        halftest.model.reconnect(reload=True)
        self.hotAssertOnUpdateCascade(self.RelB, 'b_a_fkey')
    ...
    def test_set_null(self):
        ...
        halftest.model.reconnect(reload=True)
        self.hotAssertOnUpdateSetNull(self.RelB, 'b_a_fkey')
    ...
    def test_set_default(self):
        ...
        halftest.model.reconnect(reload=True)
        self.hotAssertOnUpdateSetDefault(self.RelB, 'b_a_fkey')
