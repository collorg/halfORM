...
class Test(TestCase):
    ...
    def tearDown(self):
        halftest.Post().ho_delete(delete_all=True)
    ...
    def test_ho_delete_returns_none(self):
        ...
        d_res = self.post.ho_insert('id')
        self.assertEqual(len(halftest.Post(**d_res)), 1)
        self.assertEqual(halftest.Post(**d_res).ho_delete(), None)
    ...
    def test_ho_delete_returning_id(self):
        ...
        d_res = self.post.ho_insert('id')
        self.assertEqual(len(halftest.Post(**d_res)), 1)
        self.assertEqual(halftest.Post(**d_res).ho_delete('id'), [d_res])
        self.assertEqual(len(halftest.Post(**d_res)), 0)
    ...
    def test_ho_delete_returning_id_and_title(self):
        ...
        d_res = self.post.ho_insert('id', 'title')
        self.assertEqual(len(halftest.Post(**d_res)), 1)
        self.assertEqual(halftest.Post(**d_res).ho_delete('id', 'title'), [d_res])
        self.assertEqual(len(halftest.Post(**d_res)), 0)
    ...
    def test_ho_delete_returning_all(self):
        ...
        d_res = self.post.ho_insert('*')
        self.assertEqual(len(halftest.Post(**d_res)), 1)
        self.assertEqual(halftest.Post(**d_res).ho_delete('*'), [d_res])
        self.assertEqual(len(halftest.Post(**d_res)), 0)
    ...
    def test_ho_update_returns_none(self):
        ...
        self.assertEqual(halftest.Post(**d_res).ho_update(title=n_title), None)
        self.assertEqual(len(halftest.Post(**d_res)), 0)
    ...
    def test_ho_update_returning_id(self):
        ...
        self.assertEqual(halftest.Post(**d_res).ho_update('id', title=n_title), [d_res])
        d_res['title'] = n_title
        self.assertEqual(len(halftest.Post(**d_res)), 1)
    ...
    def test_ho_update_returning_id_and_title(self):
        ...
        self.assertEqual(halftest.Post(**d_res).ho_update('id', 'title', title=n_title), [n_d_res])
        self.assertEqual(len(halftest.Post(**d_res)), 0)
    ...
    def test_ho_update_returning_all(self):
        ...
        n_d_res = dict(d_res)
        n_d_res['title'] = n_title
        self.assertEqual(halftest.Post(**d_res).ho_update('*', title=n_title), [n_d_res])
        self.assertEqual(len(halftest.Post(**d_res)), 0)
